...
func (r *DockerCluster) ValidateCreate() (admission.Warnings, error) {
...
func (r *DockerCluster) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
func (r *DockerCluster) ValidateDelete() (admission.Warnings, error) {
